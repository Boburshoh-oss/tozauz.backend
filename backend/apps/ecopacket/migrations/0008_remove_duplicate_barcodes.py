...
def remove_duplicate_barcodes(apps, schema_editor):
    ...
    if to_delete:
        ...
        print(f"Deleted {len(to_delete)} duplicate bar_codes, kept {len(seen)} unique bar_codes")
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(remove_duplicate_barcodes, reverse_code=migrations.RunPython.noop),
    ]
