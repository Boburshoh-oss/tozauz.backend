...
from ..views.flask_qr_view import FlaskQrManualMultipleView, FlaskQrManualSingleView, UniversalQrManualSingleView, UniversalQrCheckView
from rest_framework.routers import DefaultRouter
from django.urls import path, include
from apps.ecopacket.views.flask_qr_view import FlaskQrManualMultipleView, FlaskQrManualSingleView, UniversalQrManualSingleView, UniversalQrCheckView
